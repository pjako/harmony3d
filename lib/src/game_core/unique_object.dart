...
class GUIDGen {
  ...
  int generate() {
    ...
    int pos = (int.parse(uuid[10], radix: 16) & 0x3) | 0x8; // bits 6-7 of the clock_seq_hi_and_reserved to 01

    uuid[7] = "4";  // bits 12-15 of the time_hi_and_version field to 0010
