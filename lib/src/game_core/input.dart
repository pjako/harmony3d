...
class Input {
  ...
  /// Mouse position x
  static int get mouseX => _inputDevice.mouseX;
  /// Mouse position y
  static int get mouseY => _inputDevice.mouseY;
  /// Mouse position x delta since last tick.
  static int get mouseDx => _inputDevice.mouseDx;
  /// Mouse position y delta since last tick.
  static int get mouseDy => _inputDevice.mouseDy;
  /// Mouse position x clamped to canvas
  static int get mouseClampX => _inputDevice.mouseClampX;
  /// Mouse position y clamped to canvas
  static int get mouseClampY => _inputDevice.mouseClampY;
  /// Mouse wheel delta x since last tick
  static int get wheelDx => _inputDevice.wheelDx;
  /// Mouse wheel delta y since last tick
  static int get wheelDy => _inputDevice.wheelDy;
  static bool get mouseWithinCanvas => _inputDevice.mouseWithinCanvas;
  ...
  static bool buttonDown(int buttonId) {
    return _inputDevice.buttonDown(buttonId);
  }
  ...
  static bool keyDown(int keyId) {
    return _inputDevice.keyDown(keyId);
  }
  ...
  static dynamic getGamePad(int pad) {
    return _inputDevice.getGamePad(pad);
  }
